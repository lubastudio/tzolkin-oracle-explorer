    ...
    <div className="bg-tzolkin-lightBg rounded-lg p-4 shadow-lg">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-gray-300">{seal.description}</p>
        </div>
        
        <div className="text-center">
          <h3 className="text-3xl font-bold mb-2">Kin {kin}</h3>
          <h3 className="text-2xl">{tone.name} {seal.name}</h3>
          <p className="text-sm text-gray-300 mt-2">
            {tone.description} • {seal.description}
          </p>
        </div>
        
        <div className="flex flex-col items-center">
          <div className={`w-24 h-24 rounded-full flex items-center justify-center mb-2 bg-gradient-to-br from-primary to-violet-900 cursor-pointer hover:scale-105 transition`}>
            <span className="text-3xl font-bold">{tone.number}</span>
          </div>
