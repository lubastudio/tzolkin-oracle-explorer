...
export const solarSeals = [
  { name: "Dragão Vermelho", color: "red", description: "Nascimento / Nutrição" },
  { name: "Vento Branco", color: "white", description: "Sopro / Comunicação" },
  { name: "Noite Azul", color: "blue", description: "Abundância / Sonho" },
  { name: "Semente Amarela", color: "yellow", description: "Florescimento / Foco" },
  { name: "Serpente Vermelha", color: "red", description: "Força Vital / Desejo" },
  { name: "Enlaçador de Mundos Branco", color: "white", description: "Transição / Desapego" },
  { name: "Mão Azul", color: "blue", description: "Realização / Cura" },
  { name: "Estrela Amarela", color: "yellow", description: "Elegância / Arte" },
  { name: "Lua Vermelha", color: "red", description: "Emoção / Fluxo" },
  { name: "Cachorro Branco", color: "white", description: "Coração / Amor" },
  { name: "Macaco Azul", color: "blue", description: "Magia / Brincadeira" },
  { name: "Humano Amarelo", color: "yellow", description: "Livre-Arbítrio / Sabedoria" },
  { name: "Caminhante do Céu Vermelho", color: "red", description: "Espaço / Expansão" },
  { name: "Mago Branco", color: "white", description: "Intemporalidade / Encantamento" },
  { name: "Águia Azul", color: "blue", description: "Visão / Criação" },
  { name: "Guerreiro Amarelo", color: "yellow", description: "Inteligência / Coragem" },
  { name: "Terra Vermelha", color: "red", description: "Navegação / Sincronicidade" },
  { name: "Espelho Branco", color: "white", description: "Infinito / Ordem" },
  { name: "Tormenta Azul", color: "blue", description: "Autogeração / Energia" },
  { name: "Sol Amarelo", color: "yellow", description: "Fogo Universal / Vida" },
];

// 13 Galactic Tones
export const galacticTones = [
  { name: "Magnético", number: 1, description: "Propósito / Atração" },
  { name: "Lunar", number: 2, description: "Desafio / Estabilização" },
  { name: "Elétrico", number: 3, description: "Serviço / Vínculo" },
  { name: "Autoexistente", number: 4, description: "Forma / Definição" },
  { name: "Harmônico", number: 5, description: "Emanação / Potência" },
  { name: "Rítmico", number: 6, description: "Igualdade / Organização" },
  { name: "Ressonante", number: 7, description: "Sintonização / Canalização" },
  { name: "Galáctico", number: 8, description: "Coerência / Integridade" },
  { name: "Solar", number: 9, description: "Intenção / Impulso" },
  { name: "Planetário", number: 10, description: "Manifestação / Aperfeiçoamento" },
  { name: "Espectral", number: 11, description: "Liberação / Entrega" },
  { name: "Cristal", number: 12, description: "Cooperação / Dedicação" },
  { name: "Cósmico", number: 13, description: "Presença / Transcendência" },
];
